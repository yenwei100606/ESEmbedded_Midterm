...
void set_sysclk_pll(void)
{
	...
	//SET_BIT(RCC_BASE+RCC_CR_OFFSET,PLLON_BIT); //use HSE for PLL source
	...
	//wait
	while(READ_BIT(RCC_BASE+RCC_CFRG_OFFSET,SWS_1_BIT)!=1 || READ_BIT(RCC_BASE+RCC_CFRG_OFFSET,SWS_0_BIT)!=0)
		;	
}
